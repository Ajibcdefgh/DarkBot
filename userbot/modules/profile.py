...
async def remove_profilepic(delpfp):
    ...
    await delpfp.edit(f"`Berhasil dihapus {len(input_photos)} foto profil.`")


CMD_HELP.update(
    {
        "profile": ">`.username <nama baru>`"
        ...
        "\n\n>`.delpfp` atau >`.delpfp <nomor>/<semua>`"
        "\nUsage: Menghapus gambar profil Telegram Anda."
        "\n\n>`.reserved`"
